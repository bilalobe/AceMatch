    ...
    case 1: { // Add reservation
      ...
      if (client != nullptr) {
        ...
        if (partie != nullptr) {
          ...
          // Select a terrain (you'll need to prompt the user)
          // ...
          TypeTerrain type;
          ...
          Terrain* terrain = tennisChampionship.gestionTerrains.rechercherTerrain(type, longueur, largeur); // Find the terrain
          ...
          if (terrain->isSeatAvailable(row, col)) {
            ...
            Reservation reservation(client, partie, terrain, row, col); // Create Reservation with terrain, row, and col
...
void displayScoreManagementMenu() {
  ...
  switch (choice) {
    case 1: { // Add score
      ...
      Partie* partie = tennisChampionship.gestionParties.rechercherPartie(matchNumber); 
    ...
    case 4: { // Display all scores
      gestionScores.afficherScores(); 
      break; 
    }
    case 5: { // Display Top Scorers
...
void displayTicketsMenu() {
  ...
  switch (choice) {
    case 1: { // Generate a ticket
      ...
      // ... (The place selection logic as before) ...
